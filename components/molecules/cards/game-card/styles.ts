...
export const GameCardContent = styled.div<GameCardContainerProps>`
  height: ${(props) => (props.$card_type == "main" ? "20rem" : "auto")};
  display: flex;
  flex-direction: ${(props) => (props.$card_type == "main" ? "row" : "column")};
  align-items: ${(props) =>
    props.$card_type == "main" ? "center" : "flex-start"};
  justify-content: ${(props) =>
    props.$card_type == "main" ? "space-between" : "flex-start"};
  gap: 2rem;
  padding: ${(props) =>
    props.$card_type == "main" ? "3.8rem 6.4rem 3.8rem 3.2rem " : "1.6rem 2rem"};
  border-radius: 1rem;
...
export const GameTitle = styled.div<GameCardContainerProps>`
  color: var(--neutrals_light_100);
  font-family: var(--font_primary);
  font-size: ${(props) => (props.$card_type == "main" ? "3rem" : "2rem")};
  font-weight: 600;
  text-transform: uppercase;
`;
...
export const GameAmount = styled.div<GameCardContainerProps>`
  color: var(--neutrals_light_100);
  font-family: var(--font_primary);
  font-size: ${(props) => (props.$card_type == "main" ? "3.6rem" : "2.4rem")};
  font-weight: 600;
`;
...
export const GameContest = styled.p<GameCardContainerProps>`
  ...
  color: var(--neutrals_light_100);
  font-family: var(--font_primary);
  font-size: ${(props) => (props.$card_type == "main" ? "2rem" : "1.4rem")};
  text-transform: uppercase;
  font-weight: 500;
`;
...
export const GameButton = styled.div<GameCardContainerProps>`
  width: ${(props) => (props.$card_type == "main" ? "28rem" : "100%")};
  height: ${(props) => (props.$card_type == "main" ? "6rem" : "4rem")};
  display: flex;
  align-items: center;
  justify-content: center;
  gap: 1rem;
  ...
  font-family: var(--font_primary);
  font-size: ${(props) => (props.$card_type == "main" ? "1.8rem" : "1.4rem")};
  font-weight: 700;
  text-transform: uppercase;
